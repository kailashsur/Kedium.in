...
export default function TopNav(){
    ...
    return(<div className={` lg:hidden flex ${!data?.access_token ? "justify-between" : "justify-center"} items-center h-10 pt-0 pb-0 pl-6 pr-6 bg-white border-b border-borderGrey transition-all`}>
